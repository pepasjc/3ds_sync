...
- **PS3 `PARAM.PFD` resigning / save decryption** (`ps3/source/pfd.c`, `ps3/source/decrypt.c`) — based on analysis of [Apollo Save Tool](https://github.com/bucanero/apollo-ps3) by **Damián Parrino (bucanero)** and **flatz**'s `pfd_sfo_tools`.
